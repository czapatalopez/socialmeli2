...
public class PostServiceTest {
    ...
    */
    ...
    private List<Post> generateMockPosts(Integer id){
        if(id==2){
            return List.of(
                    new Post(2,2,"15-02-2024", new Product(2,"ASUS ROG","Gamer","Asus","Negro","nueva"),10,15000.0),
                    new Post(4,2,"01-02-2024", new Product(4,"Teclado Gamer","Gamer","HyperX","Negro","Elite Alloy"),10,2300.0)
            );
        }else if(id==3){
            return List.of(
                    new Post(3, 3, "11-02-2024", new Product(3, "Silla gamer", "Gamer", "Racer", "Negro y azul", "special edition"), 100, 1500.0),
                    new Post(5, 3, "01-01-2024", new Product(56, "Mouse", "Office", "Logitech", "Negro", "G203"), 40, 200.0),
                    new Post(6, 3, "18-02-2024", new Product(12, "Termo", "Office", "Yeti", "Gris", "Large"), 40, 1200.0)
            );
        }else{
            return List.of(
                    new Post(2,2,"30-01-2024", new Product(2,"ASUS ROG","Gamer","Asus","Negro","nueva"),10,15000.0),
                    new Post(4,2,"20-01-2024", new Product(4,"Teclado Gamer","Gamer","HyperX","Negro","Elite Alloy"),10,2300.0)
            );
        }
